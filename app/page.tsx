...
const View = dynamic(() => import('@/components/canvas/View').then((mod) => mod.View), {
  ssr: false,
  loading: () => <div className='h-[1600px] w-full flex items-center justify-center' />,
})
...
const SocialLinks = ({ visible, theme }: { visible: boolean; theme: string }) => {
  const isDark = theme === 'dark'
  ...
  return (
    ...
    >
      ...
      <div className={classNames('w-px h-20', isDark ? 'bg-white/15' : 'bg-black/15')} />
    </motion.div>
  )
}
